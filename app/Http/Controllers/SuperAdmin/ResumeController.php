...
class ResumeController extends Controller
{
    public function index(Request $request)
    {
        ...
        return Inertia::render('SuperAdmin/Resume/Index', [
    ...
    {
        return Inertia::render('SuperAdmin/Resume/Form', [
            'mode' => 'create',
            'resume' => null,
        ]);
    }
    ...
    public function show(Resume $resume)
    {
        ...
        return Inertia::render('SuperAdmin/Resume/Show', [
            'resume' => $resume,
        ]);
    }
