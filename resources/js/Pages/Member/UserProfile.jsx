...
export default function Dashboard() {
    ...
    useEffect(() => {
        if (croppedImage) {
            ...
            router.post(route("member.profile.photo.update"), formData, {
                onSuccess: () => {},
                onError: (errors) => {
    ...
    const handleProfileUpdate = (e) => {
        e.preventDefault();
        router.post(route("member.profile.update"), formData, {
            onError: (errors) => {
    ...
    const handlePasswordChange = (e) => {
        ...
        router.post(route("member.profile.password.update"), formData, {
            onSuccess: () => {
    ...
    const handleRemoveProfilePhoto = () => {
        ...
        router.post(
            route("member.profile.photo.remove"),
            {},
            {
                onSuccess: () => {
