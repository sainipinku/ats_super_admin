        ...
        <div className="bg-white rounded-2xl shadow-sm border border-slate-200 hover:shadow-lg hover:border-blue-300 transition-all duration-300 overflow-hidden">
            ...
            <div className="p-5">
                ...
                <div className="mt-4 p-3 bg-slate-50 rounded-xl">
                    ...
                    <p className="text-xs text-slate-600">{application.job?.company} • {application.job?.location}</p>
                </div>
...
export default function JobApplicants({ auth }) {
    ...
    return (
        <AuthenticatedLayout
            header={<h2 className="text-xl font-semibold text-slate-800">All Job Applicants</h2>}
        >
