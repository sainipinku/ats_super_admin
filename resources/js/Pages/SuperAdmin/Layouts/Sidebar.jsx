...
export default function Sidebar({ isOpen, onClose }) {
    ...
    return (
        <>
            ...
            <aside
                className={`fixed  left-0 z-40 h-[calc(100vh-62px)] w-[288px] bg-white text-slate-900 shadow-md transition-transform duration-300 dark:bg-[#03011C] dark:text-white ${
