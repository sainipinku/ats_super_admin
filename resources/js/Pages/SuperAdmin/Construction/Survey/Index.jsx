                        ...
                        {surveySubmissions.length ? (
                            <div className="space-y-4">
                                {surveySubmissions.map((submission) => (
                                    <SubmissionReviewCard key={submission.id} submission={submission} routeName="super.construction.survey.submissions.review" />
                                ))}
                            </div>
                        ) : (
...
function SubmissionReviewCard({ submission, routeName }) {
    const form = useForm({
