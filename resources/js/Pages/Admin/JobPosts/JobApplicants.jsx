            ...
            <div className="p-5">
                <div className="flex items-start gap-4">
                    ...
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="text-slate-600 dark:text-gray-300 text-sm">{application.candidate_email}</p>
                        {application.candidate_phone && (
                            <p className="text-slate-500 dark:text-gray-400 text-xs mt-0.5">{application.candidate_phone}</p>
                        )}
                    </div>
                </div>
                ...
                <div className="mt-4 p-3 bg-slate-50 dark:bg-gray-700/50 rounded-xl">
                    ...
                    <p className="text-sm font-semibold text-slate-800 dark:text-white">{application.job?.title}</p>
                    <p className="text-xs text-slate-600 dark:text-gray-300">{application.job?.company}</p>
                </div>
                    ...
                    <div className="mt-3">
                        ...
                        <div className="flex flex-wrap gap-1">
                            {application.candidate_skills.slice(0, 3).map((skill, idx) => (
                                <span key={idx} className="px-2 py-0.5 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-xs rounded-md border border-blue-100 dark:border-blue-800">
                                    {skill}
                                </span>
                            ))}
...
const StatusFilter = ({ label, count, active, onClick, color }) => {
    ...
    return (
        ...
        >
            <span>{label}</span>
            <span className={`px-2 py-0.5 rounded-full text-xs ${active ? 'bg-white/50' : 'bg-slate-100 dark:bg-gray-700'}`}>
                {count}
            </span>
        </button>
    );
...
export default function JobApplicants({ auth }) {
    ...
    return (
        ...
        >
            ...
            <div className="py-6 bg-slate-100 dark:bg-gray-900 min-h-screen">
                        ...
                        <div className="flex flex-col md:flex-row gap-4">
                            ...
                            <div className="flex-1">
                                <div className="relative">
                                    <input
                                        ...
                                        className="w-full pl-10 pr-4 py-2.5 border border-slate-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                    />
                                    <svg
                            ...
                            <div className="md:w-64">
                                <select
                                    ...
                                    className="w-full px-4 py-2.5 border border-slate-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                >
                        ...
                        <div className="mt-6 flex items-center justify-between bg-white dark:bg-gray-800 rounded-xl border border-slate-200 dark:border-gray-700 px-4 py-3">
                            ...
                            <div className="flex gap-2">
                                <button
                                    ...
                                    className="px-4 py-2 text-sm font-medium text-slate-700 dark:text-gray-300 bg-white dark:bg-gray-800 border border-slate-300 dark:border-gray-600 rounded-lg hover:bg-slate-50 dark:hover:bg-gray-700 disabled:opacity-50 disabled:cursor-not-allowed"
                                >
                                    Previous
                                </button>
                                <button
            ...
            {showDetailsModal && selectedApplication && (
                <div className="fixed inset-0 z-50 overflow-y-auto">
                    <div className="flex items-center justify-center min-h-screen px-4 pt-4 pb-20 text-center sm:block sm:p-0">
                        <div className="fixed inset-0 transition-opacity bg-gray-500 bg-opacity-75 dark:bg-gray-900 dark:bg-opacity-75" onClick={() => setShowDetailsModal(false)}></div>
                        ...
                        <div className="inline-block align-bottom bg-white dark:bg-gray-800 rounded-2xl text-left overflow-hidden shadow-xl transform transition-all sm:my-8 sm:align-middle sm:max-w-2xl sm:w-full">
                            <div className="bg-white dark:bg-gray-800 px-4 pt-5 pb-4 sm:p-6 sm:pb-4">
                                ...
                                <div className="mb-6 p-4 bg-slate-50 dark:bg-gray-700/50 rounded-xl">
                                    <p className="text-xs text-slate-500 dark:text-gray-400 mb-1">Applied for:</p>
                                    <p className="text-lg font-semibold text-slate-800 dark:text-white">{selectedApplication.job?.title}</p>
                                    <p className="text-sm text-slate-600 dark:text-gray-300">{selectedApplication.job?.company} • {selectedApplication.job?.location}</p>
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
                                    <div className="p-3 border border-slate-200 dark:border-gray-600 rounded-xl">
                                        <p className="text-xs text-slate-500 dark:text-gray-400">Phone</p>
                                        <p className="text-sm font-medium text-slate-800 dark:text-white">{selectedApplication.candidate_phone || 'Not provided'}</p>
                                    </div>
                                    <div className="p-3 border border-slate-200 dark:border-gray-600 rounded-xl">
                                    ...
                                    <div className="mb-6">
                                        ...
                                        <div className="flex flex-wrap gap-2">
                                            {selectedApplication.candidate_skills.map((skill, idx) => (
                                                <span key={idx} className="px-3 py-1 bg-blue-50 dark:bg-blue-900/30 text-blue-700 dark:text-blue-300 text-sm rounded-lg border border-blue-100 dark:border-blue-800">
                                                    {skill}
                                                </span>
                                            ))}
                                        </div>
                                ...
                                {selectedApplication.candidate_experience && (
                                    <div className="mb-6">
                                        ...
                                        <p className="text-sm text-slate-600 dark:text-gray-300 bg-slate-50 dark:bg-gray-700/50 p-3 rounded-xl">
                                ...
                                {selectedApplication.cover_letter && (
                                    <div className="mb-6">
                                        ...
                                        <p className="text-sm text-slate-600 dark:text-gray-300 bg-slate-50 dark:bg-gray-700/50 p-3 rounded-xl whitespace-pre-wrap">
                                            {selectedApplication.cover_letter}
                                        </p>
                                    </div>
                                )}
                                ...
                                <div className="border-t border-slate-200 dark:border-gray-700 pt-4">
                                    ...
                                    <div>
                                        ...
                                        <textarea
                                            ...
                                            rows={3}
                                            className="w-full px-3 py-2 border border-slate-200 dark:border-gray-600 rounded-xl focus:ring-2 focus:ring-blue-500 focus:border-blue-500 outline-none text-sm resize-none bg-white dark:bg-gray-800 text-gray-900 dark:text-white"
                                        />
                                        <button
