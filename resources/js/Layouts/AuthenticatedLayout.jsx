                        ...
                        <div className="mx-auto max-w-full px-4 sm:px-6 lg:px-8">
                            <div className="flex h-16 justify-between border-gray-200 dark:border-gray-700">
                                <div className="flex">
                                    ...
                                    {/* Commented out navigation links - can be uncommented as needed */}
                            ...
                            {/* Commented out second header with dropdown menus */}
                            ...
                            {/* Commented out mobile menu sections */}
                            ...
                            {/* Commented out expanded mobile menu */}
                            ...
                            {/* Commented out responsive navigation dropdown */}
                            {/* <div className={(showingNavigationDropdown ? 'block' : 'hidden') + ' sm:hidden'}>
                                <div className="space-y-1 pb-3 pt-2">
                                    {/* Commented out responsive nav links */}
                                {/* </div> */}
